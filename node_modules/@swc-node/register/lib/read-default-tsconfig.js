...
function tsCompilerOptionsToSwcConfig(options, filename) {
    ...
    return {
        ...
        emitDecoratorMetadata: (_c = options.emitDecoratorMetadata) !== null && _c !== void 0 ? _c : false,
        esModuleInterop: (_d = options.esModuleInterop) !== null && _d !== void 0 ? _d : false,
        swc: {
            filename,
            ...
            jsc: {
                ...
                paths: Object.fromEntries(Object.entries((_e = options.paths) !== null && _e !== void 0 ? _e : {}).map(([aliasKey, aliasPaths]) => {
                    var _a;
                    return [
                        aliasKey,
                ...
                keepClassNames: true,
                target: toTsTarget((_f = options.target) !== null && _f !== void 0 ? _f : ts.ScriptTarget.ES2018),
                transform: {
