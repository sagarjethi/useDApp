...
function compileSolcjs(config) {
    return async function compile(sources) {
        ...
        const imports = (0, findImports_1.findImports)(sources);
...
async function loadCompiler({ compilerVersion, cacheDirectory }) {
    ...
    if ((0, utils_1.isDirectory)(compilerVersion)) {
...
async function fetchReleases() {
    if (!cache) {
        const res = await (0, node_fetch_1.default)(VERSION_LIST_URL);
...
async function loadVersion(version, cacheDirectory) {
    ...
    if (!(0, utils_1.isFile)(cachedSolcPath)) {
...
async function cacheRemoteVersion(version, cacheDirectory) {
    ...
    if (!(0, utils_1.isDirectory)(solcCacheDirectory)) {
    ...
    await new Promise((resolve, reject) => {
        https_1.default.get(url, (response) => {
            ...
            try {
                ...
                (0, utils_1.removeEmptyDirsRecursively)(path_1.default.resolve(cacheDirectory));
            }
            finally {
                reject(error);
            }
