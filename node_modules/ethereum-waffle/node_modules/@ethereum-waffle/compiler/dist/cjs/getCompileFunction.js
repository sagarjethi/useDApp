...
function getCompileFunction(config) {
    switch (config.compilerType) {
        case 'solcjs': return (0, compileSolcjs_1.compileSolcjs)(config);
        case 'native': return (0, compileNativeSolc_1.compileNativeSolc)(config);
        case 'dockerized-solc': return (0, compileDockerSolc_1.compileDockerSolc)(config);
        case 'dockerized-vyper': return (0, compileDockerVyper_1.compileDockerVyper)(config);
