...
function usePromiseTransaction(chainId, options) {
    ...
    const promiseTransaction = (0, react_1.useCallback)(async (transactionPromise, { safeTransaction } = {}, transactionRequest) => {
        ...
        const handleContractWallet = async ({ safeTransaction } = {}) => {
            var _a;
            ...
            const { transaction, receipt, rejected } = await (0, gnosisSafeUtils_2.waitForSafeTransaction)(gnosisSafeContract, chainId, safeTx);
            if (rejected) {
