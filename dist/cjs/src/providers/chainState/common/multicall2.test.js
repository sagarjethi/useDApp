...
chai_1.default.use(ethereum_waffle_2.solidity);
chai_1.default.use(chai_as_promised_1.default);
const Interface = ethers_1.utils.Interface;
describe('Multicall2', () => {
    const mockProvider = new ethereum_waffle_1.MockProvider();
    const [deployer] = mockProvider.getWallets();
    let tokenContract;
    let multicallContract;
    beforeEach(async () => {
        const args = ['MOCKToken', 'MOCK', deployer.address, '10000'];
        tokenContract = await (0, ethereum_waffle_2.deployContract)(deployer, constants_1.ERC20Mock, args);
        multicallContract = await (0, ethereum_waffle_2.deployContract)(deployer, constants_1.MultiCall2);
    });
