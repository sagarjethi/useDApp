...
describe('Multicall', () => {
    ...
    beforeEach(async () => {
        ...
        tokenContract = await (0, ethereum_waffle_2.deployContract)(deployer, __1.ERC20Mock, args);
        multicallContract = await (0, ethereum_waffle_2.deployContract)(deployer, __1.MultiCall);
    });
